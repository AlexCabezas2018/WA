...
/* Conversations */
usersRouter.get('/conversations/:idWith', middlewares.checkLoginMiddleware, usersController.handleConversations);
usersRouter.post('/conversations/:idWith', middlewares.checkLoginMiddleware, usersController.handleConversationsPost);
